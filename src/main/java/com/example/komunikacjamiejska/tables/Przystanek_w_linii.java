...
public class Przystanek_w_linii {
    ...
    private int odleglosc_od_nastepnego;
    ...
    public Przystanek_w_linii(int nr_linii, int nr_przystanku, int kolejnosc, int odleglosc_od_nastepnego, int czas_do_nastepnego, String czy_na_zadanie) {
        this.nr_linii = nr_linii;
        this.nr_przystanku = nr_przystanku;
        this.kolejnosc = kolejnosc;
        this.odleglosc_od_nastepnego = odleglosc_od_nastepnego;
    ...
    public int getOdleglosc_od_nastepnego() {
        return odleglosc_od_nastepnego;
    }

    public void setOdleglosc_od_nastepnego(int odleglosc_od_nastepnego) {
        this.odleglosc_od_nastepnego = odleglosc_od_nastepnego;
    }
    ...
    public String toString() {
        return "Przystanek_w_linii{" +
                ...
                ", kolejnosc=" + kolejnosc +
                ", odleglosc_od_nastepnego=" + odleglosc_od_nastepnego +
